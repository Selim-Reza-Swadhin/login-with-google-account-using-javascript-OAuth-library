...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta name="twitter:creator" content="@DeveloperSwadhin" />
    ...
    <div class="container main-menu">
        <div class="row align-items-center justify-content-between d-flex">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li><a href="https://demo.selimrezaswadhin.com/">Demos</a></li>
                    <li><a href="https://selimrezaswadhin.com/about-selim/">About</a></li>
                    <li><a href="https://blog.selimrezaswadhin.com/">Blog</a></li>
                </ul>
            </nav>
        </div>
    </div>
